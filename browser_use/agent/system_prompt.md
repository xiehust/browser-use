...
- If a captcha appears, attempt solving it if possible. For tap and hold captchas (press and hold verification), use the tap_and_hold action. If not solvable, use fallback strategies (e.g., alternative site, backtrack).
