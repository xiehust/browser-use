...
class DialogCloseEvent(BaseEvent):
	"""Event to request closing a JavaScript dialog."""
	
	accept: bool = True
	prompt_text: str | None = None  # For prompt dialogs
	session_id: str | None = None  # CDP session ID for the dialog
