...
class DOMTreeSerializer:
	...
	def _assign_interactive_indices_and_mark_new_nodes(self, node: SimplifiedNode | None) -> None:
		...
		# Pre-compute the set of previous backend node IDs once for efficiency
		...
		# Use iterative processing instead of recursion to avoid stack overflow
		# and improve performance for large DOM trees
		stack = [node]
