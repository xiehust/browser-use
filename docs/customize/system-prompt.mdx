...
- **Be specific**: Add clear, actionable instructions to guide the agent's behavior
- **Test thoroughly**: Custom prompts can significantly impact performance
- **Start small**: Begin with small extensions rather than complete overrides
- **Monitor results**: Check that your customizations improve rather than hinder performance

For examples of effective system prompt customizations, check our [community examples](https://github.com/browser-use/awesome-prompts).
